...
public interface UserFollowingRepository extends JpaRepository<UserFollowing, UserFollowingId> {
    ...
    @Query("SELECT new com.regalo_libre.follower.FollowerDTO(uf.follower.id, uf.follower.profile.appNickname, uf.followedDate) " +
    ...
    @Query("SELECT new com.regalo_libre.follower.FollowerDTO(uf.followee.id, uf.followee.profile.appNickname, uf.followedDate) " +
